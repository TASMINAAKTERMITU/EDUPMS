  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">View Patient</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" action="profile-patient.php" method="POST">
                <div class="card-body">

                  <div class="form-group">
                    <label for="usrid"> Patient ID </label>
                    <input type="textarea" class="form-control" id="usrid" placeholder="Patient ID" value="" name="usr_id">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" value="submit" class="btn btn-primary float-right">View Patient</button> 
                </div>
