            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                  ...
                  <table class="table table-striped">
                      <tr>
                        <th>ID</th> <th>Patient ID</th> <th>Symptom</th> <th>Past history</th> <th>Work day</th> <th> Status </th>
                      </tr>
                          ...
                          <?php  
                            ...
                            //
                            $sql = "SELECT * FROM appointment WHERE work_day = '$current_day' ";
                            $result = mysqli_query( $con, $sql );

                            //
                            //$sql2 = "SELECT visited_flag FROM appointment";
                            ...
                            if ($result -> num_rows > 0) {
                              ...
                              echo "<tr><td>" .$row['id']. "</td><td>" .$row['patient_id']. "</td><td>" .$row['symptom']. "</td><td>" .$row['past_history']. "</td><td>" .$row['work_day']. "</td><td>" . $row['visited_flag'] . "</td></tr>";
                              }
                              echo "</table>";
