        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form role="form" action="profile-doctor.php" method="POST">
                <div class="card-body">

                  <div class="form-group">
                    <label for="usrid"> Doctor ID </label>
                    <input type="textarea" class="form-control" id="usrid" placeholder="Doctor ID" value="<?php echo "$doctor_id"; ?>" name="usr_id">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" value="submit" class="btn btn-primary float-right">View Doctor</button> 
                </div>
